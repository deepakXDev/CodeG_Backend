...
const { isAuthenticated, requireRole, isAdmin, isAdminOrProblem_Setter } = require("../middlewares/authMiddleware");
...
const validateProblemCreation = [
  ...
  body('timeLimit').isFloat({ min: 500, max: 10000 }).withMessage('Invalid time limit'),
