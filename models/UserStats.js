...
const userStatsSchema = new mongoose.Schema({
  userId: { 
    ...
    ref: 'User', 
    required: true,
    // unique: true // ⚠️ This implicitly creates an index on "userId"
...
// Pre-save hook to initialize difficulty stats
...
// module.exports = {UserStats}  // named export